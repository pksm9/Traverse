...
//        progressDialog.dismiss();
        ...
        db.collection("users").document(firebaseAuth.getCurrentUser().getUid()).get()
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(ActivitiesSearchActivity.this, "Error : " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(ActivitiesSearchActivity.this));
