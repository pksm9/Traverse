        ...
        db.collection("users").document(firebaseAuth.getCurrentUser().getUid()).get()
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(CitySearchActivity.this, "Error : " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void populateRecyclerView(String keyword) {
        db.collection("cities")
            ...
            .addOnSuccessListener(querySnapshot -> {
                CitySnapshotAdapter adapter = new CitySnapshotAdapter(CitySearchActivity.this, querySnapshot.getDocuments(), R.layout.search_item);
